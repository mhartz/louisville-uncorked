 ...
 */
Route::get('photos/2018-winter-event', 'PagesController@WinterEvent2018');
Route::get('photos/2017-summer-event', 'PagesController@SummerEvent2017');
Route::get('photos/2017-winter-event', 'PagesController@WinterEvent2017');
Route::get('photos/2016-summer-event', 'PagesController@SummerEvent2016');
Route::get('photos/2015-fall-event', 'PagesController@FallEvent2015');
Route::get('photos/2015-fall-meeting', 'PagesController@FallMeeting2015');
Route::get('photos/2015-winter-event', 'PagesController@WinterEvent2015');
