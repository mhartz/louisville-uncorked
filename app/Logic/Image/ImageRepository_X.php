...
class ImageRepository
{
    ...
    {
        $full_size_dir = Config::get('images.photos.full-size');
    ...
    public function original( $photo, $filename )
    {
        ...
        $image = $manager->make( $photo )->encode('jpg')->save(Config::get('images.photos.full-size') . $filename );
    ...
    public function delete( $originalFilename)
    {
        ...
        $full_size_dir = Config::get('images.photos.full-size');
        $icon_size_dir = Config::get('images.photos.icon-size');
