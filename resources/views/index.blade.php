        ...
        <div class="banner">
            <section class="wrapper">
                ...
                @elseif(Config::get('constants.EVENT_THIRD_PARTY_REGISTRATION_OPEN') === true)
                    <a class="button inline-block third-party-registration" href="https://secure.qgiv.com/for/lu2/event/797821/?fbclid=IwAR29iSIcMbd2yhqMFUKReWLtFIVAbllRDqyHaqiMZ-B2wxU3YJyQAY9PNyQ" target="_blank">Buy tickets for your team</span><span class="icon-circle-right"></span></a>
                @else
