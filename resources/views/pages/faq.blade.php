...
@section('content')
  <div class="faq-content small-wrapper pt-40 pb-40">
    <section class="faq-section">
      <h3 class="question">Does my team have to be three people?</h3>
    ...
    <section class="faq-section">
      <h3 class="question"> Will there be food?</h3>
    ...
    <section class="faq-section">
      <h3 class="question">What should I wear?</h3>
